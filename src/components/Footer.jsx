    ...
    <footer>
      <div className="footer-container">
        <div className="footer-brand">
          <h2>GSM</h2>
          <p>Your premium B2B & B2C gateway for top-tier mobile phones and audiophile earphones.</p>
        </div>
        ...
        <div className="footer-contact">
          ...
          <ul>
            <li>
              ...
              <a href="mailto:sasugsm@gmail.com">sasugsm@gmail.com</a>
            </li>
            <li>
              ...
              <a href="tel:+33(0)753363186">+33 (0) 753363186</a>
            </li>
            <li>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
              <span>21 All. Valéry Larbaud, 95200 Sarcelles, France</span>
            </li>
          </ul>
        </div>

        <div className="footer-bottom">
          <p>&copy; 2026 GSM Electronics Wholesale. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
